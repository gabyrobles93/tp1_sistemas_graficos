class CastleFloor {
    constructor(size_1, size_2, height, extra_height) {
        ...
        this.floor = new Cube(this.size_1, this.size_2, height + extra_height, false, MaterialsList.CASTLE_WALL);
        this.roof = new Cube(this.size_1 + 0.3, 0.3, this.size_2 * 2 + 0.6, true, MaterialsList.CASTLE_WALL);
