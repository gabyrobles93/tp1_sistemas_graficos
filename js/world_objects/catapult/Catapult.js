class Catapult {
    constructor() {
        ...
        this.catapult_floor = new Cube(6, 2.7, 0.3, true, MaterialsList.WOOD_LIGHT);
        ...
        this.catapult_crank_1 = new Cilinder(0.05, 1.2, true, MaterialsList.WOOD_LIGHT);
        this.catapult_crank_2 = new Cilinder(0.05, 1.2, true, MaterialsList.WOOD_LIGHT);
