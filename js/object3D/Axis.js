class Axis {
    constructor() {
        this.x = new Cilinder(0.02, 3, true, MaterialsList.COLOR_AXIS_RED);
        this.y = new Cilinder(0.02, 3, true, MaterialsList.COLOR_AXIS_GREEN);
        this.z = new Cilinder(0.02, 3, true, MaterialsList.COLOR_AXIS_BLUE);
    }
