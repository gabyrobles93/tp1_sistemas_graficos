class CastleTower2D {
    ...
    _fillPoints() {
        ...
        this.points.push([5.5, 15, 0]);
        this.normal_points.push([1, 0, 0]);

        this.points.push([5.5, 15.5, 0]);
        this.normal_points.push([1, 0, 0]);
        ...
        this.points.push([4.5, 15.5, 0]);
        this.normal_points.push([-1, 0, 0]);

        this.points.push([4.5, 15, 0]);
        this.normal_points.push([-1, 0, 0]);

        this.points.push([4.5, 14.5, 0]);
        this.normal_points.push([-1, 0, 0]);
        ...
        this.points.push([3.5, 14, 0]);
        this.normal_points.push([0, 1, 0]);

        this.points.push([2.5, 14, 0]);
        this.normal_points.push([0, 1, 0]);

        this.points.push([1.5, 14, 0]);
        this.normal_points.push([0, 1, 0]);

        this.points.push([0.5, 14, 0]);
        this.normal_points.push([0, 1, 0]);
